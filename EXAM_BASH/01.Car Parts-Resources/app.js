...
function solve() {
        ...
        //implement nextButton logic
                ...
                if (!carModelValue || carYearValue < 1980 && carYearValue > 2023 || !partNameValue || !partNumberValue || !conditionValue) {
                        return;
                }
    ...
    visibilityText.textContent = "";
                ...
                continueBtn.addEventListener('click', (e) => {
                        ...
                        listItem.removeChild(editBtn); listItem.removeChild(continueBtn);
